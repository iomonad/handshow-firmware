...
#define GAP_ADTYPE_TX_POWER_LEVEL                                              \
...
#define GAP_ADTYPE_OOB_SIMPLE_PAIRING_RANDR                                    \
...
#define GAP_ADTYPE_SLAVE_CONN_INTERVAL_RANGE                                   \
  0x12 //!< Min and Max values of the connection interval (2 octets Min, 2
       //!< octets Max) (0xFFFF indicates no conn interval min or max)
#define GAP_ADTYPE_SERVICES_LIST_16BIT                                         \
  0x14 //!< Service Solicitation: list of 16-bit Service UUIDs
#define GAP_ADTYPE_SERVICES_LIST_32BIT                                         \
  0x1F //!< Service Solicitation: list of 32-bit Service UUIDs
...
#define GAP_ADTYPE_SERVICE_DATA_UUID_128BIT                                    \
...
#define GAP_ADTYPE_LE_BLUETOOTH_DEVICE_ADDR                                    \
  0x1B                          //!< ​LE Bluetooth Device Address
#define GAP_ADTYPE_LE_ROLE 0x1C //!< LE Role
#define GAP_ADTYPE_SIMPLE_PAIRING_HASHC_256 0x1D //!< Simple Pairing Hash C-256
#define GAP_ADTYPE_SIMPLE_PAIRING_RAND_R256                                    \
  0x1E //!< Simple Pairing Randomizer R-256
#define GAP_ADTYPE_3D_INFORMATION_DATA                                         \
  0x3D //!< 3D Synchronization Profile, v1.0 or later
#define GAP_ADTYPE_MANUFACTURER_SPECIFIC                                       \
  0xFF //!< Manufacturer Specific Data: first 2 octets contain the Company
       //!< Identifier Code followed by the additional manufacturer specific
       //!< data
