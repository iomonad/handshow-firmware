...
#define LL_FEATURE_MASK_CONNECTION_PARA_REQUEST_PROCEDURE                      \
  (0x00000002)                                                  // core_4.1
#define LL_FEATURE_MASK_EXTENDED_REJECT_INDICATION (0x00000004) // core_4.1
#define LL_FEATURE_MASK_SLAVE_INITIATED_FEATURES_EXCHANGE                      \
  (0x00000008)                                                // core_4.1
...
#define LL_FEATURE_ENABLE_LE_DATA_LENGTH_EXTENSION                             \
  BLE_CORE42_DATA_LENGTH_EXTENSION_ENABLE
...
#define LL_FEATURE_ENABLE_LE_EXTENDED_ADVERTISING                              \
  LL_FEATURE_SUPPORT_LE_EXTENDED_ADVERTISING
#define LL_FEATURE_ENABLE_LE_PERIODIC_ADVERTISING                              \
  LL_FEATURE_SUPPORT_LE_PERIODIC_ADVERTISING
#define LL_FEATURE_ENABLE_CHANNEL_SELECTION_ALGORITHM2                         \
  LL_FEATURE_SUPPORT_CHANNEL_SELECTION_ALGORITHM2
...
typedef enum {
  ...
  //// HCI Status, See the Core_v5.0(Vol 2/Part D/1.3 "list of Error Codes") for
  ///more information)
 ...
 *				  |--public
 *.....................................................
 *BLE_DEVICE_ADDRESS_PUBLIC
 *                |
 * Address Type --|		      |-- random static
 *................................. BLE_DEVICE_ADDRESS_RANDOM_STATIC | |
 *    			  |--random --|
 * 			   				  |
...
#define IS_RANDOM_STATIC_ADDR(Type, Addr)                                      \
  ((Type) == BLE_ADDR_RANDOM && (Addr[5] & 0xC0) == 0xC0)
...
#define IS_RESOLVABLE_PRIVATE_ADDR(Type, Addr)                                 \
  ((Type) == BLE_ADDR_RANDOM && (Addr[5] & 0xC0) == 0x40)
...
typedef struct {
  u32 dma_len; // won't be a fixed number as previous, should adjust with the
               // mouse package number
...
typedef struct {
  u16 intervalMin; // Minimum advertising interval for non-directed advertising,
                   // time = N * 0.625ms
  u16 intervalMax; // Maximum advertising interval for non-directed advertising,
                   // time = N * 0.625ms
