...
#define HCI_REVISION                                                           \
  0x0002 // Revision of the Current HCI in the BR/EDR Controller
#define HCI_LMP_VERSION                                                        \
  0x09 // Version of the Current LMP or PAL in the Controller, Bluetooth Core
       // Specification 5.0
#define HCI_MANUFACTURER_NAME                                                  \
  VENDOR_ID // Manufacturer Name of the BR/EDR Controller
#define HCI_LMP_SUBVERSION                                                     \
  0x0001 // Subversion of the Current LMP or PAL in the Controller
...
#define HCI_SUB_EVT_LE_PERIODIC_ADVERTISING_SYNC_ESTABLISHED                   \
  0x0E // core_5.0 - LE Periodic Advertising Sync Established Event -
       // [5] 7.7.65.14
...
#define HCI_SUB_EVT_LE_SCAN_TIMEOUT                                            \
  0x11 // core_5.0 - LE Scan Timeout Event - [5] 7.7.65.17
#define HCI_SUB_EVT_LE_ADVERTISING_SET_TERMINATED                              \
  0x12 // core_5.0 - LE Advertising Set Terminated Event - [5]7.7.65.18
#define HCI_SUB_EVT_LE_SCAN_REQUEST_RECEIVED                                   \
  0x13 // core_5.0 - LE Scan Request Received Event - [5]7.7.65.19
#define HCI_SUB_EVT_LE_LE_CHANNEL_SELECTION_ALGORITHM                          \
...
#define HCI_LE_EVT_MASK_PERIODIC_ADVERTISING_SYNC_ESTABLISHED                  \
  0x00002000                                                      // core5.0
...
#define HCI_LE_EVT_MASK_EXTENDED_ADVERTISING_SET_TERMINATED                    \
  0x00020000                                             // core5.0
#define HCI_LE_EVT_MASK_SCAN_REQUEST_RECEIVED 0x00040000 // core5.0
#define HCI_LE_EVT_MASK_CHANNEL_SELECTION_ALGORITHM                            \
  0x00080000 // core5.0 - bit19
...
#define HCI_EVT_CMD_COMPLETE_STATUS(n, c, g, s)                                \
  ((n << 0) | (c << 8) | (g << 16) | (s << 24))
...
#define HCI_CMD_LE_SET_DEFAULT_PHY                                             \
  0x31                          // LE Set Default PHY Command - [5] 7.8.48
#define HCI_CMD_LE_SET_PHY 0x32 // LE Set PHY Command - [5] 7.8.49
#define HCI_CMD_LE_ENHANCED_RECEIVER_TEST                                      \
  0x33 // LE Enhanced Receiver Test Command - [5] 7.8.50
#define HCI_CMD_LE_ENHANCED_TRANSMITTER_TEST                                   \
  0x34 // LE Enhanced Transmitter Test Command - [5] 7.8.51
...
#define HCI_CMD_LE_SET_EXTENDED_ADVERTISING_DATA                               \
  0x37 // LE Set Extended Advertising Data Command - [5] 7.8.54
#define HCI_CMD_LE_SET_EXTENDED_SCAN_RESPONSE_DATA                             \
  0x38 // LE Set Extended Scan Response Data Command - [5] 7.8.55
#define HCI_CMD_LE_SET_EXTENDED_ADVERTISING_ENABLE                             \
  0x39 // LE Set Extended Advertising Enable Command - [5] 7.8.56
...
#define HCI_CMD_LE_REMOVE_ADVERTISING_SET                                      \
  0x3C // LE Remove Advertising Set Command - [5] 7.8.59
#define HCI_CMD_LE_CLEAR_ADVERTISING_SETS                                      \
  0x3D // LE Clear Advertising Sets Command - [5] 7.8.60
#define HCI_CMD_LE_SET_PERIODIC_ADVERTISING_PARAMETERS                         \
  0x3E // LE Set Periodic Advertising Parameters Command - [5] 7.8.61
#define HCI_CMD_LE_SET_PERIODIC_ADVERTISING_DATA                               \
  0x3F // LE Set Periodic Advertising Data Command - [5] 7.8.62
#define HCI_CMD_LE_SET_PERIODIC_ADVERTISING_ENABLE                             \
  0x40 // LE Set Periodic Advertising Enable Command - [5] 7.8.63
#define HCI_CMD_LE_SET_EXTENDED_SCAN_PARAMETERS                                \
  0x41 // LE Set Extended Scan Parameters Command - [5] 7.8.64
#define HCI_CMD_LE_SET_EXTENDED_SCAN_ENABLE                                    \
  0x42 // LE Set Extended Scan Enable Command - [5] 7.8.65
#define HCI_CMD_LE_EXTENDED_CREATE_CONNECTION                                  \
  0x43 // LE Extended Create Connection Command - [5] 7.8.66
#define HCI_CMD_LE_PERIODIC_ADVERTISING_CREATE_SYNC                            \
  0x44 // LE Periodic Advertising Create Sync Command- [5] 7.8.67
...
#define HCI_CMD_LE_CLEAR_PERIODIC_ADVERTISER_LIST                              \
  0x49 // LE Clear Periodic Advertiser List Command - [5] 7.8.72
#define HCI_CMD_LE_READ_PERIODIC_ADVERTISER_LIST_SIZE                          \
  0x4A // LE Read Periodic Advertiser List Size Command - [5] 7.8.73
#define HCI_CMD_LE_READ_TRANSMIT_POWER                                         \
  0x4B // LE Read Transmit Power Command - [5] 7.8.74
#define HCI_CMD_LE_READ_RF_PATH_COMPENSATION                                   \
  0x4C // LE Read RF Path Compensation Command - [5] 7.8.75
#define HCI_CMD_LE_WRITE_RF_PATH_COMPENSATION                                  \
  0x4D // LE Write RF Path Compensation Command - [5] 7.8.76
#define HCI_CMD_LE_SET_PRIVACY_MODE                                            \
  0x4E // LE Set Privacy Mode Command - [5] 7.8.77
// core_5.0 end
