...
/**
 *  @brief   "Operation" in "LE Set Extended Advertising Data Command" and "LE
...
/**
 *  @brief   "Fragment_Preference" in "LE Set Extended Advertising Data Command"
 * and "LE Set Extended Scan Response Data Command"
 */
typedef enum {
...
/**
 *  @brief  Command Parameters Definition for "HCI LE Set Extended Advertising
 * Parameters Command"
 */
typedef struct {
  u8 adv_handle;
