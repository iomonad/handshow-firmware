...
#define GATT_UUID_CLIENT_CHAR_CFG                                              \
  0x2902 //!< Client Characteristic Configuration
#define GATT_UUID_SERVER_CHAR_CFG                                              \
...
// Telink Service
////////////////////////////////////
#define TELINK_SPP_UUID_SERVICE                                                \
  {                                                                            \
    0x10, 0x19, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP service
#define TELINK_AUDIO_UUID_SERVICE                                              \
  {                                                                            \
    0x11, 0x19, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP service
#define TELINK_OTA_UUID_SERVICE                                                \
  {                                                                            \
    0x12, 0x19, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_OTA service
#define TELINK_MESH_UUID_SERVICE                                               \
  {                                                                            \
    0x20, 0x19, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP service
#define TELINK_MESH_LT_UUID_SERVICE                                            \
  {                                                                            \
    0x21, 0x19, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP service

#define TELINK_SPP_DATA_SERVER2CLIENT                                          \
  0x10, 0x2B, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,      \
      0x03, 0x02, 0x01, 0x00 //!< TELINK_SPP data from server to client
#define TELINK_SPP_DATA_CLIENT2SERVER                                          \
  {                                                                            \
    0x11, 0x2B, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
...
#define TELINK_SPP_DATA_PAIR                                                   \
  {                                                                            \
    0x13, 0x2B, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP data for ota
#define TELINK_SPP_DATA_DEFINE                                                 \
  {                                                                            \
    0x14, 0x2B, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP data for userdefine data

#define TELINK_MIC_DATA                                                        \
  {                                                                            \
    0x18, 0x2B, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP data from server to client
#define TELINK_SPEAKER_DATA                                                    \
  {                                                                            \
    0x19, 0x2B, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,    \
        0x03, 0x02, 0x01, 0x00                                                 \
  } //!< TELINK_SPP data from client to server
 ...
 */
/**
 *  @brief  External variable for GATT UUID which can be used in service
 * definition
 */
