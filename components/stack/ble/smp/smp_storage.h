...
#define SMP_PARAM_NV_SEC_ADDR_START                                            \
  (SMP_PARAM_NV_ADDR_START + SMP_PARAM_NV_MAX_LEN)
#define SMP_PARAM_NV_SEC_ADDR_END                                              \
  (SMP_PARAM_NV_SEC_ADDR_START + SMP_PARAM_NV_MAX_LEN - 1)

#define NEW_FLASH_STORAGE_KEY_ENABLE                                           \
  0 // be compatible with old flash storage methods
...
#define FLAG_SMP_PARAM_SAVE_UNANTHEN                                           \
  0x9A // 1001 1010  new storage Unauthenticated_LTK
#define FLAG_SMP_PARAM_SAVE_AUTHEN                                             \
  0xAA // 1010 1010  new storage Authenticated_LTK_Legacy_Paring
#define FLAG_SMP_PARAM_SAVE_AUTHEN_SC                                          \
  0xBA // 1011 1010  new storage Authenticated_LTK_Secure_Connection
...
u32 bls_smp_param_loadByAddr(u8 addr_type, u8 *addr,
