...
/******************************* Macro & Enumeration variables for Stack, user
 * can not use!!!!  ********************************/
...
#define IS_CONNECTION_HANDLE_VALID(handle)                                     \
  (handle != BLE_INVALID_CONNECTION_HANDLE)

/////////////////////////////////////////////////////////////////////////////
#define FLG_RF_CONN_DONE                                                       \
  (FLD_RF_IRQ_CMD_DONE | FLD_RF_IRQ_FSM_TIMEOUT | FLD_RF_IRQ_FIRST_TIMEOUT |   \
   FLD_RF_IRQ_RX_TIMEOUT | FLD_RF_IRQ_RX_CRC_2)
