...
ble_sts_t blm_ll_updateConnection(u16 connHandle, u16 conn_min, u16 conn_max,
                                  u16 conn_latency, u16 timeout, u16 ce_min,
                                  u16 ce_max);
...
int blm_att_discoveryService(u16 connHandle, att_db_uuid16_t *p16, int n16,
                             att_db_uuid128_t *p128, int n128);
...
ble_sts_t blm_hci_receiveHostACLData(u16 connHandle, u8 PB_Flag, u8 BC_Flag,
                                     u8 *pData);
