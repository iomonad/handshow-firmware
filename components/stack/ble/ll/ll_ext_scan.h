...
/******************************************** User Interface
 * ********************************************************************/
ble_sts_t blc_ll_setExtScanParam_1_phy(own_addr_type_t ownAddrType,
                                       scan_fp_type_t scanFilterPolicy,
                                       u8 scan_phys, scan_type_t scanType,
                                       u16 scan_interval, u16 scan_window);

ble_sts_t blc_hci_le_setExtScanEnable(scan_en_t extScan_en,
                                      dupFilter_en_t filter_duplicate,
                                      u16 duration, u16 period);

/****************************************** Stack Interface, user can not use!!!
 * *************************************************/

ble_sts_t blc_hci_le_setExtScanParam(own_addr_type_t ownAddrType,
                                     scan_fp_type_t scanFilterPolicy,
                                     u8 scan_phys, u8 *pData);
