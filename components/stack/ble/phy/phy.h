...
typedef struct {
  ...
  u8 conn_next_CI;
  u8 phy_req_trigger; // 1: means current device triggers phy_req, due to API
                      // "blc_ll_setPhy" called by Host or Application
  u8 phy_req_pending;
...
ble_sts_t blc_ll_setDefaultPhy(le_phy_prefer_mask_t all_phys,
