...
#define TR_T_TIMER_E                                                           \
  29 // user define tick log id, from 30 - 40,  10 valid for using

#define TR_T_user0 30

#define TR_24_TIMERS_ADDR                                                      \
  0 // this ID cant be used because timer id == 0 is reserved for indicating id
    // not added
