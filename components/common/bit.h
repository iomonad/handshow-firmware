...
#define BITS7(a, b, c, d, e, f, g)                                             \
  (BIT(a) | BIT(b) | BIT(c) | BIT(d) | BIT(e) | BIT(f) | BIT(g))
#define BITS8(a, b, c, d, e, f, g, h)                                          \
  (BIT(a) | BIT(b) | BIT(c) | BIT(d) | BIT(e) | BIT(f) | BIT(g) | BIT(h))
...
#define BIT_SET_HIGH(x)                                                        \
  ((x) |= BIT((sizeof((x)) * 8 - 1))) // set the highest bit
#define BIT_CLR_HIGH(x)                                                        \
  ((x) &= ~BIT((sizeof((x)) * 8 - 1))) // clr the highest bit
#define BIT_IS_SET_HIGH(x)                                                     \
  ((x) & BIT((sizeof((x)) * 8 - 1))) // check the higest bit
...
#define CLAMP_TO_ONE(x)                                                        \
  (!!(x)) // compiler defined, not stardard.    0 --> 0,   1 --> 0xffffffff
                                                                                    ...
                                                                                    : (((y) &                         \
                                                                                        BIT(12))                      \
                                                                                           ...
                                                                                           : (                        \
                                                                                                 ((y) & BIT(13)) ? 13 \
                                                                                                                 : (  \
                                                                                                                       ((y) & BIT(14)) ? 14 : (((y) & BIT(15)) ? 15 : (((y) & BIT(16)) ? 16 : (((y) & BIT(17)) ? 17 : (((y) & BIT(18)) ? 18 : (((y) & BIT(19)) ? 19 : (((y) & BIT(20)) ? 20 : (((y) & BIT(21)) ? 21 : (((y) & BIT(22)) ? 22 : (((y) & BIT(23)) ? 23 : (((y) & BIT(24)) ? 24 : (((y) & BIT(25)) ? 25 : (((y) & BIT(26)) ? 26 : (((y) & BIT(27)) ? 27 : (((y) & BIT(28)) ? 28 : (((y) & BIT(29)) ? 29 : (((y) & BIT(30)) ? 30 : (((y) & BIT(31)) ? 31 : 32))))))))))))))))))))))))))))))))
...
#define MASK_VAL8(m1, v1, m2, v2, m3, v3, m4, v4)                              \
...
#define MASK_VAL14(m1, v1, m2, v2, m3, v3, m4, v4, m5, v5, m6, v6, m7, v7)     \
  (MV(m1, v1) | MV(m2, v2) | MV(m3, v3) | MV(m4, v4) | MV(m5, v5) |            \
   MV(m6, v6) | MV(m7, v7))
#define MASK_VAL16(m1, v1, m2, v2, m3, v3, m4, v4, m5, v5, m6, v6, m7, v7, m8, \
                   v8)                                                         \
  (MV(m1, v1) | MV(m2, v2) | MV(m3, v3) | MV(m4, v4) | MV(m5, v5) |            \
   MV(m6, v6) | MV(m7, v7) | MV(m8, v8))
...
#define SET_FLD_FULL_V7(x, m1, v1, m2, v2, m3, v3)                             \
  ((x) = MASK_VAL6(m1, v1, m2, v2, m3, v3))
#define SET_FLD_FULL_V9(x, m1, v1, m2, v2, m3, v3, m4, v4)                     \
  ((x) = MASK_VAL8(m1, v1, m2, v2, m3, v3, m4, v4))
...
#define SET_FLD_V3(x, m, v)                                                    \
  __pragma(warning(push)) __pragma(warning(disable : 4244))                    \
      BM_SET_MASK_FLD(x, m, MV(m, v)) __pragma(warning(pop))
...
#define SET_FLD_V9(x, m1, v1, m2, v2, m3, v3, m4, v4)                          \
  __pragma(warning(push)) __pragma(warning(disable : 4244)) BM_SET_MASK_FLD(   \
      x, m1 | m2 | m3 | m4, MV(m1, v1) | MV(m2, v2) | MV(m3, v3) | MV(m4, v4)) \
      __pragma(warning(pop))
...
#define SET_FLD_V11(x, m1, v1, m2, v2, m3, v3, m4, v4, m5, v5)                 \
  __pragma(warning(push)) __pragma(warning(disable : 4244))                    \
      BM_SET_MASK_FLD(x, m1 | m2 | m3 | m4 | m5,                               \
                      MV(m1, v1) | MV(m2, v2) | MV(m3, v3) | MV(m4, v4) |      \
                          MV(m5, v5)) __pragma(warning(pop))

#define SET_FLD_V13(x, m1, v1, m2, v2, m3, v3, m4, v4, m5, v5, m6, v6)         \
  __pragma(warning(push)) __pragma(warning(disable : 4244))                    \
      BM_SET_MASK_FLD(x, m1 | m2 | m3 | m4 | m5 | m6,                          \
                      MV(m1, v1) | MV(m2, v2) | MV(m3, v3) | MV(m4, v4) |      \
                          MV(m5, v5) | MV(m6, v6)) __pragma(warning(pop))
#endif
