...
static int aes_ecb_encrypt(const uint8_t *pKey, uint8_t *input,
                           uint8_t *output) {
 ...
 */
int aes_ccm_encrypt_and_tag(const unsigned char *key, const unsigned char *iv,
                            size_t iv_len, const unsigned char *add,
                            size_t add_len, const unsigned char *input,
                            size_t length, unsigned char *output,
                            unsigned char *tag, size_t tag_len) {
  return (ccm_auth_crypt(CCM_ENCRYPT, key, iv, iv_len, add, add_len, input,
                         length, output, tag, tag_len));
}

/*
 * Authenticated decryption
 */
int aes_ccm_auth_decrypt(const unsigned char *key, const unsigned char *iv,
                         size_t iv_len, const unsigned char *add,
                         size_t add_len, const unsigned char *input,
                         size_t length, unsigned char *output,
  ...
  if ((ret = ccm_auth_crypt(CCM_DECRYPT, key, iv, iv_len, add, add_len, input,
                            length, output, check_tag, tag_len)) != 0) {
    return (ret);
  }
...
static uint8_t nonce[13] = {0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16,
