 ...
 */
extern UINT16 mjac_cmd_build_echo(UINT8 *cmd, UINT16 cmd_sz,
 ...
 * @return length of the built cmd.
 */
extern UINT16 mjac_cmd_build_generate_random(UINT8 *cmd, UINT16 cmd_sz,
                                             UINT8 random_sz);

/**
 * @brief hibernate to low power consumption.
 *        cause chip will hibernate immediatly, you SHOULD just read
 * MJAC_SZ_HEAD_TAIL once.
 *
 * @param cmd - out buffer.
 *
 * @return length of the built cmd.
 */
extern UINT16 mjac_cmd_build_hibernate(UINT8 *cmd, UINT16 cmd_sz);
 ...
 * @return length of the built cmd.
 */
extern UINT16 mjac_cmd_build_read(UINT8 *cmd, UINT16 cmd_sz, mjac_zone_t idx,
 ...
 * @return length of the built cmd.
 */
extern UINT16 mjac_cmd_build_generate_signature(UINT8 *cmd, UINT16 cmd_sz,
                                                const UINT8 *hash,
                                                UINT16 hash_sz);
 ...
 */
extern UINT16
mjac_cmd_build_verify_signature(UINT8 *cmd, UINT16 cmd_sz, const UINT8 *pubkey,
                                UINT16 pubkey_sz, const UINT8 *signature,
 ...
 * @return length of the built cmd.
 */
extern UINT16 mjac_cmd_build_establish_key(UINT8 *cmd, UINT16 cmd_sz,
                                           const UINT8 *pubkey,
                                           UINT16 pubkey_sz);
 ...
 * @return length of the built cmd.
 */
extern UINT16 mjac_cmd_build_generate_key(UINT8 *cmd, UINT16 cmd_sz);
 ...
 * @return length of the built cmd.
 */
extern UINT16 mjac_cmd_build_query(UINT8 *cmd, UINT16 cmd_sz);
 ...
 */
extern mjac_resp_code_t mjac_resp_parse_data(UINT8 *resp, UINT16 *data_sz);

extern UINT16 mjac_cmd_build_update(UINT8 *cmd, UINT16 cmd_sz, mjac_zone_t idx,
                                    UINT16 offset, const UINT8 *data,
                                    UINT16 data_sz);
