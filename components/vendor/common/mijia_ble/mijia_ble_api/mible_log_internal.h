...
#define MI_ERROR_PREFIX                                                        \
  MI_LOG_ERROR_COLOR "[E] " MI_LOG_MODULE_NAME MI_LOG_BREAK
#define MI_WARNING_PREFIX                                                      \
  MI_LOG_WARNING_COLOR "[W] " MI_LOG_MODULE_NAME MI_LOG_BREAK
#define MI_INFO_PREFIX MI_LOG_INFO_COLOR "[I] " MI_LOG_MODULE_NAME MI_LOG_BREAK
#define MI_DEBUG_PREFIX                                                        \
  MI_LOG_DEBUG_COLOR "[D] " MI_LOG_MODULE_NAME MI_LOG_BREAK
