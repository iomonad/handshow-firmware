...
#define DMA_RFRX_OFFSET_TIME_STAMP(p)                                          \
  (p[DMA_RFRX_OFFSET_RFLEN] + 9) // data len:4
#define DMA_RFRX_OFFSET_FREQ_OFFSET(p)                                         \
  (p[DMA_RFRX_OFFSET_RFLEN] + 13) // data len:2
#define DMA_RFRX_OFFSET_RSSI(p)                                                \
  (p[DMA_RFRX_OFFSET_RFLEN] + 15) // data len:1, signed
