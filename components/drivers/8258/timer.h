...
static inline unsigned long clock_time(void) { return reg_system_tick; }
...
static inline unsigned int clock_time_exceed(unsigned int ref,
                                             unsigned int us) {
 ...
 * @return    none
 */
extern void timer0_set_mode(TIMER_ModeTypeDef mode, unsigned int init_tick,
                            unsigned int cap_tick);
 ...
 * @return    none
 */
extern void timer1_set_mode(TIMER_ModeTypeDef mode, unsigned int init_tick,
                            unsigned int cap_tick);
 ...
 * @return    none
 */
extern void timer2_set_mode(TIMER_ModeTypeDef mode, unsigned int init_tick,
                            unsigned int cap_tick);
