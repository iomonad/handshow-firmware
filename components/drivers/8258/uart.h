 ...
 * @return     none
 */
extern void uart_init(unsigned short g_uart_div, unsigned char g_bwpc,
 ...
 * @return     none
 */
extern void uart_init_baudrate(unsigned int Baudrate, unsigned int System_clock,
 ...
 * 0x9d ie 0x9d[3]. uart_ndma_get_irq  If the cnt register value(0x9c[0,3])
 * larger or equal than the value of 0x99[0,3] or the cnt register
 * value(0x9c[4,7]) less or equal than the value of 0x99[4,7], it will set the
 * irq bit of status register 0x9d, ie 0x9d[3]
 * @param[in] rx_level - receive level value. ie 0x99[0,3]
 * @param[in] tx_level - transmit level value.ie 0x99[4,7]
 * @return    none
 */
extern void uart_ndma_irq_triglevel(unsigned char rx_level,
...
extern void uart_recbuff_init(unsigned char *RecvAddr,
...
extern void uart_set_rts(unsigned char Enable, UART_RTSModeTypeDef Mode,
 ...
 * @return     none
 */
extern void uart_set_cts(unsigned char Enable, unsigned char Select,
                         UART_CtsPinDef pin);
