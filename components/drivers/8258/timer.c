 ...
 * @return    none
 */
void timer0_set_mode(TIMER_ModeTypeDef mode, unsigned int init_tick,
 ...
 * @return    none
 */
void timer1_set_mode(TIMER_ModeTypeDef mode, unsigned int init_tick,
                     unsigned int cap_tick) {
  switch (mode) {
  case TIMER_MODE_SYSCLK: {
 ...
 * @return    none
 */
void timer2_set_mode(TIMER_ModeTypeDef mode, unsigned int init_tick,
                     unsigned int cap_tick) {
  switch (mode) {
  case TIMER_MODE_SYSCLK: {
