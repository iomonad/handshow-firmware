 ...
 *              not 0: failure
 */
extern int aes_encrypt(unsigned char *Key, unsigned char *Data,
 ...
 *              not 0: failure
 */
extern int aes_decrypt(unsigned char *Key, unsigned char *Data,
                       unsigned char *Result);
 ...
 *              not 0: failure
 */
extern int aes_dma_encrypt(unsigned char *Key, unsigned long *Data,
 ...
 *              not 0: failure
 */
extern int aes_dma_decrypt(unsigned char *Key, unsigned long *Data,
                           unsigned short DataSize, unsigned long *Result,
                           unsigned short ResultSize);
