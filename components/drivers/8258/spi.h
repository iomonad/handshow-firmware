...
extern void spi_write(unsigned char *Cmd, int CmdLen, unsigned char *Data,
                      int DataLen, GPIO_PinTypeDef CSPin);
...
extern void spi_read(unsigned char *Cmd, int CmdLen, unsigned char *Data,
                     int DataLen, GPIO_PinTypeDef CSPin);
