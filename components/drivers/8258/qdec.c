 ...
 * @return     none.
 */
void qdec_set_pin(QDEC_InputAchTypeDef channelA,
                  QDEC_InputBchTypeDef channelB) {
...
/**
 * @brief      This function servers to reset the counter and the QDEC Counter
 * value is cleared zero.
 * @param[in]  none.
 * @return     none.
 */
