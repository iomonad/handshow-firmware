...
static inline unsigned char irq_enable(void) {
  unsigned char r = reg_irq_en; // don't worry,  the compiler will optimize the
                                // return value if not used
  reg_irq_en = 1;
  return r;
}
 ...
 */
static inline void irq_restore(unsigned char en) { reg_irq_en = en; }
 ...
 */
static inline unsigned long irq_get_mask(void) { return reg_irq_mask; }
 ...
 * @return     IRQ source.
 */
static inline unsigned long irq_get_src() { return reg_irq_src; }
 ...
 * @return     none.
 */
static inline void irq_clr_src2(unsigned long msk) { reg_irq_src |= msk; }
...
static inline void irq_clr_src(void) { reg_irq_src = 0xffffffff; }
 ...
 * @return     none.
 */
static inline void rf_irq_enable(unsigned int msk) { reg_rf_irq_mask |= msk; }
 ...
 */
static inline unsigned short rf_irq_src_get(void) { return reg_rf_irq_status; }
