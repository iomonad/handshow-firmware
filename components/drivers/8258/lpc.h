...
/**
 * @brief 		This function selects input reference voltage for low
 * power comparator .
 * @param[in] 	mode - lower power comparator working mode includes normal mode
 * and low power mode.
...
/**
 * @brief 		This function serves to set scaling_coefficient for low
 * power comparator .
