 ...
 * @return     none.
 */
static inline void dfifo_set_dfifo0(unsigned short *pbuff,
 ...
 * @return     none.
 */
static inline void dfifo_set_dfifo1(unsigned short *pbuff,
                                    unsigned int size_buff) {
 ...
 * @return     none.
 */
static inline void dfifo_set_dfifo2(unsigned short *pbuff,
                                    unsigned int size_buff) {
 ...
 * @return     none.
 */
static inline void adc_config_misc_channel_buf(unsigned short *pbuff,
                                               unsigned int size_buff)
...
static inline void audio_config_mic_buf(unsigned short *pbuff,
                                        unsigned int size_buff) {
