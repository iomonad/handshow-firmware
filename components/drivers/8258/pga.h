...
/// set FLD_PGA_POST_AMPLIFIER_GAIN of reg_pga_fix_value (0xb63<0:5>) range
/// -10~14dB
typedef enum {
...
#define SET_PGA_GAIN_FIX_VALUE(v)                                              \
  do {                                                                         \
    unsigned char val = 0;                                                     \
