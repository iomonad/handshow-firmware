...
#define GPIO_PA0_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA0_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PA0_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PA0_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA0_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
...
#define GPIO_PA1_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA1_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PA1_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PA1_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA1_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
...
#define GPIO_PA2_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA2_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PA2_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PA2_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA2_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
...
#define GPIO_PA3_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0xC0;                                                              \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA3_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val &= ~0x80;                                                              \
    val |= 0x40;                                                               \
...
#define GPIO_PA3_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PA3_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
  } while (0)
#define GPIO_PA3_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0e_pa0_pa3_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_0e_pa0_pa3_pull, val);                                   \
...
#define GPIO_PA4_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA4_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PA4_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PA4_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA4_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
...
#define GPIO_PA5_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA5_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PA5_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PA5_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA5_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
...
#define GPIO_PA6_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA6_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PA6_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PA6_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA6_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
...
#define GPIO_PA7_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0xC0;                                                              \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA7_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val &= ~0x80;                                                              \
    val |= 0x40;                                                               \
...
#define GPIO_PA7_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PA7_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
  } while (0)
#define GPIO_PA7_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_0f_pa4_pa7_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_0f_pa4_pa7_pull, val);                                   \
...
#define GPIO_PB0_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
  } while (0)
#define GPIO_PB0_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PB0_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PB0_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
  } while (0)
#define GPIO_PB0_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
...
#define GPIO_PB1_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
  } while (0)
#define GPIO_PB1_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PB1_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PB1_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
  } while (0)
#define GPIO_PB1_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
...
#define GPIO_PB2_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
  } while (0)
#define GPIO_PB2_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PB2_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PB2_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
  } while (0)
#define GPIO_PB2_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
...
#define GPIO_PB3_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PB3_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
  } while (0)
#define GPIO_PB3_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_10_pb0_pb3_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_10_pb0_pb3_pull, val);                                   \
...
#define GPIO_PB4_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB4_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PB4_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PB4_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB4_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
...
#define GPIO_PB5_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB5_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PB5_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PB5_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB5_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
...
#define GPIO_PB6_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB6_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PB6_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PB6_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB6_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
...
#define GPIO_PB7_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0xC0;                                                              \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB7_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val &= ~0x80;                                                              \
    val |= 0x40;                                                               \
...
#define GPIO_PB7_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PB7_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
  } while (0)
#define GPIO_PB7_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_11_pb4_pb7_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_11_pb4_pb7_pull, val);                                   \
...
#define GPIO_PC0_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC0_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PC0_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PC0_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC0_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
...
#define GPIO_PC1_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC1_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PC1_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PC1_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC1_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
...
#define GPIO_PC2_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC2_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PC2_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PC2_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC2_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
...
#define GPIO_PC3_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0xC0;                                                              \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC3_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val &= ~0x80;                                                              \
    val |= 0x40;                                                               \
...
#define GPIO_PC3_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PC3_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
  } while (0)
#define GPIO_PC3_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_12_pc0_pc3_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_12_pc0_pc3_pull, val);                                   \
...
#define GPIO_PC4_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC4_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PC4_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PC4_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC4_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
...
#define GPIO_PC5_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC5_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PC5_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PC5_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC5_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
...
#define GPIO_PC6_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC6_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PC6_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PC6_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC6_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
...
#define GPIO_PC7_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0xC0;                                                              \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC7_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val &= ~0x80;                                                              \
    val |= 0x40;                                                               \
...
#define GPIO_PC7_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PC7_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
  } while (0)
#define GPIO_PC7_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_13_pc4_pc7_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_13_pc4_pc7_pull, val);                                   \
...
#define GPIO_PD0_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD0_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PD0_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PD0_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD0_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
...
#define GPIO_PD1_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD1_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PD1_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PD1_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD1_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
...
#define GPIO_PD2_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD2_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PD2_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PD2_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD2_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
...
#define GPIO_PD3_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0xC0;                                                              \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD3_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val &= ~0x80;                                                              \
    val |= 0x40;                                                               \
...
#define GPIO_PD3_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PD3_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
  } while (0)
#define GPIO_PD3_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_14_pd0_pd3_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_14_pd0_pd3_pull, val);                                   \
...
#define GPIO_PD4_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0x03;                                                              \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD4_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0x02;                                                              \
    val |= 0x01;                                                               \
...
#define GPIO_PD4_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0x02;                                                               \
    val &= ~0x01;                                                              \
...
#define GPIO_PD4_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0x03;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD4_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val ^= 0x01;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
...
#define GPIO_PD5_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0x0C;                                                              \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD5_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0x08;                                                              \
    val |= 0x04;                                                               \
...
#define GPIO_PD5_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0x08;                                                               \
    val &= ~0x04;                                                              \
...
#define GPIO_PD5_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0x0C;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD5_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val ^= 0x04;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
...
#define GPIO_PD6_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0x30;                                                              \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD6_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0x20;                                                              \
    val |= 0x10;                                                               \
...
#define GPIO_PD6_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0x20;                                                               \
    val &= ~0x10;                                                              \
...
#define GPIO_PD6_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0x30;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD6_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val ^= 0x10;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
...
#define GPIO_PD7_PULL_FLOAT                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0xC0;                                                              \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD7_PULL_UP_1M                                                    \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val &= ~0x80;                                                              \
    val |= 0x40;                                                               \
...
#define GPIO_PD7_PULL_DOWN_100K                                                \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0x80;                                                               \
    val &= ~0x40;                                                              \
...
#define GPIO_PD7_PULL_UP_10K                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val |= 0xC0;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
  } while (0)
#define GPIO_PD7_PULL_TOGGLE                                                   \
  do {                                                                         \
    unsigned char val = analog_read(areg_15_pd4_pd7_pull);                     \
    val ^= 0x40;                                                               \
    analog_write(areg_15_pd4_pd7_pull, val);                                   \
