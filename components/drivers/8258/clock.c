...
_attribute_ram_code_ void clock_init(SYS_CLK_TypeDef SYS_CLK) {
  ...
  if (SYS_CLK == SYS_CLK_48M_Crystal) {
    /*default c4: dcdc 1.8V  -> GD flash£º 48M clock may error £¬ need higher
       DCDC voltage c6: dcdc 1.9V
    */
...
/**
 * @brief     This function performs to select 48M RC as the system clock
 * source.
 * @param[in] none.
 * @return    none.
 */
