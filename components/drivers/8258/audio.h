 ...
 */
typedef enum { AUDIO_8K, AUDIO_16K, AUDIO_32K, RATE_SIZE } AudioRate_Typedef;
...
/**
 * 	@brief     audio DMIC init function, config the speed of DMIC and
 * downsample audio data to required speed.         actually audio data is
 * dmic_speed/d_samp.
 * 	@param[in] Audio_Rate - set the DMIC speed. such as 1 indicate 1M and 2
 * indicate 2M.
 * 	@return    none.
 */
void audio_dmic_init(AudioRate_Typedef Audio_Rate);
/**
 * 	@brief     audio USB init function, config the speed of DMIC and
 * downsample audio data to required speed. actually audio data is
 * dmic_speed/d_samp.
 * 	@param[in] Audio_Rate - set the DMIC speed. such as 1 indicate 1M and 2
 * indicate 2M.
...
/**
 * 	@brief     audio I2S init in function, config the speed of i2s and MCLK
 * to required speed.
 * 	@param[in] none.
 * 	@return    none.
 */
 ...
 * 	@param[in] 	InType		- select audio input type including amic
 * ,dmic ,i2s and usb
 * 	@param[in] 	Audio_Rate 	- select audio rate, which will decide
 * on which adc sampling rate and relative decimation configuration will be
 * chosen.
 * 	@return	  	none
 */
