...
// mulit-byte keycode for media keys, cannot used directly in c code..for
// reference
...
#define VK_W_BACK_V                                                            \
  { 0x24, 0x02 }
#define VK_W_FORWRD_V                                                          \
  { 0x25, 0x02 }
#define VK_W_STOP_V                                                            \
  { 0x26, 0x02 }
#define VK_W_REFRESH_V                                                         \
  { 0x27, 0x02 }
// favorite
#define VK_W_FAV_V                                                             \
  { 0x2a, 0x02 }
...
#define VK_MY_COMP_V                                                           \
  { 0x94, 0x01 }
// next track -- 01(mosue-ep/USB_EDP_MOUSE) 05(len)
// 03(kb-report-id/USB_HID_KB_MEDIA) b5(val) 00 00 00
#define VK_MENU_V                                                              \
  { 0x40, 0x00 }
#define VK_MENU_PICK_V                                                         \
  { 0x41, 0x00 }
#define VK_MENU_UP_V                                                           \
  { 0x42, 0x00 }
#define VK_MENU_DN_V                                                           \
  { 0x43, 0x00 }
#define VK_MENU_LEFT_V                                                         \
  { 0x44, 0x00 }
#define VK_MENU_RIGHT_V                                                        \
  { 0x45, 0x00 }
...
#define VK_RECORD_V                                                            \
  { 0xb2, 0x00 }
#define VK_FAST_FORWARD_V                                                      \
  { 0xb3, 0x00 }
#define VK_REWIND_V                                                            \
  { 0xb4, 0x00 }
#define VK_NEXT_TRK_V                                                          \
  { 0xb5, 0x00 }
#define VK_PREV_TRK_V                                                          \
  { 0xb6, 0x00 }
#define VK_STOP_V                                                              \
  { 0xb7, 0x00 }
#define VK_PLAY_PAUSE_V                                                        \
  { 0xcd, 0x00 }
#define VK_W_MUTE_V                                                            \
  { 0xe2, 0x00 }
#define VK_VOL_UP_V                                                            \
