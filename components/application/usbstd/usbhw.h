...
enum {
  USB_EDP_PRINTER_IN = 8,   // endpoint 8 is alias of enpoint 0,  becareful.  //
                            // default hw buf len = 64
  ...
  USB_EDP_SOMATIC_IN =
      USB_EDP_AUDIO_IN, //  when USB_SOMATIC_ENABLE, USB_EDP_PRINTER_OUT disable
