...
static inline u32 usbhw_get_ctrl_ep_irq(void) { return reg_ctrl_ep_irq_sta; }
...
static inline void usbhw_reset_ctrl_ep_ptr(void) { reg_ctrl_ep_ptr = 0; }
...
static inline void usbhw_reset_ep_ptr(u32 ep) { reg_usb_ep_ptr(ep & 0x07) = 0; }
