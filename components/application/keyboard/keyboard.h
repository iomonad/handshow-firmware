...
typedef struct {
  ...
  // unsigned char padding[2];	//  for  32 bit padding,  if KB_RETURN_KEY_MAX
  // change,  this should be changed
} kb_data_t;
...
extern unsigned int kb_scan_key_value(int numlock_status, int read_key,
                                      unsigned char *gpio);
