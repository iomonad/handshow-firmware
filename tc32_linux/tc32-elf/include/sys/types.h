...
#ifndef __CYGWIN__
#if defined(__MS_types__) || defined(__rtems__) || defined(__sparc__) ||       \
    defined(__SPU__)
...
*/
      ...
      defined(_WINSOCKAPI_) || defined(__USE_W32_SOCKETS))
...
#endif /* !(defined (_POSIX_SOURCE) || defined (_WINSOCK_H) || defined         \
