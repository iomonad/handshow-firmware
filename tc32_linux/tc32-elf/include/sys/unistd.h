...
int _EXFUN(execve,
           (const char *__path, char *const __argv[], char *const __envp[]));
int _EXFUN(execvp, (const char *__file, char *const __argv[]));
#if defined(__CYGWIN__)
int _EXFUN(execvpe,
           (const char *__file, char *const __argv[], char *const __envp[]));
int _EXFUN(faccessat,
           (int __dirfd, const char *__path, int __mode, int __flags));
#endif
...
#endif
#if defined(__CYGWIN__)
int _EXFUN(fchownat, (int __dirfd, const char *__path, uid_t __owner,
...
int _EXFUN(iruserok, (unsigned long raddr, int superuser, const char *ruser,
                      const char *luser));
#endif
...
#if defined(__CYGWIN__)
int _EXFUN(linkat, (int __dirfd1, const char *__path1, int __dirfd2,
                    const char *__path2, int __flags));
#endif
...
ssize_t _EXFUN(pwrite,
               (int __fd, const void *__buf, size_t __nbytes, off_t __offset));
...
#if defined(__CYGWIN__)
int _EXFUN(ruserok, (const char *rhost, int superuser, const char *ruser,
                     const char *luser));
#endif
...
#if defined(__CYGWIN__)
ssize_t _EXFUN(readlinkat, (int __dirfd1, const char *__path, char *__buf,
                            size_t __buflen));
#endif
