...
int _EXFUN(pthread_attr_setstack,
...
int _EXFUN(pthread_setspecific, (pthread_key_t __key, _CONST void *__value));
...
void _EXFUN(pthread_cleanup_push, (void (*__routine)(void *), void *__arg));
...
int _EXFUN(pthread_barrier_init,
           (pthread_barrier_t * __barrier, _CONST pthread_barrierattr_t *__attr,
            unsigned __count));
...
int _EXFUN(pthread_spin_init, (pthread_spinlock_t * __spinlock, int __pshared));
