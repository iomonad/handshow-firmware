...
#define __tg_cplx(expr) __builtin_classify_type(expr) == 9
...
#define __tg_choose(x, f, d, l)                                                \
  __builtin_choose_expr(__tg_ldbl(x), l,                                       \
                        __builtin_choose_expr(__tg_dbl(x), d, f))

#define __tg_choose_2(x, y, f, d, l)                                           \
  __builtin_choose_expr(                                                       \
      __tg_ldbl(x) || __tg_ldbl(y), l,                                         \
      __builtin_choose_expr(__tg_dbl(x) || __tg_dbl(y), d, f))

#define __tg_choose_3(x, y, z, f, d, l)                                        \
  __builtin_choose_expr(                                                       \
      __tg_ldbl(x) || __tg_ldbl(y) || __tg_ldbl(z), l,                         \
      __builtin_choose_expr(__tg_dbl(x) || __tg_dbl(y) || __tg_dbl(z), d, f))
...
#define __TGMATH_CPLX_2(z1, z2, R, C)                                          \
  __builtin_choose_expr(                                                       \
      __tg_cplx(z1) || __tg_cplx(z2),                                          \
      __tg_choose_2(__real__(z1), __real__(z2), C##f(z1, z2), (C)(z1, z2),     \
                    C##l(z1, z2)),                                             \
      __tg_choose_2(z1, z2, R##f(z1, z2), (R)(z1, z2), R##l(z1, z2)))

#define __TGMATH_REAL(x, R) __tg_choose(x, R##f(x), (R)(x), R##l(x))
