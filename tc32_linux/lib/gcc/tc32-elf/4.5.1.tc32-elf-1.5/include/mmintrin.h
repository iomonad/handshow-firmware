...
static __inline __m64 _mm_cvtsi64_m64(__int64 __i) { return __i; }

static __inline __int64 _mm_cvtm64_si64(__m64 __i) { return __i; }

static __inline int _mm_cvtsi64_si32(__int64 __i) { return __i; }

static __inline __int64 _mm_cvtsi32_si64(int __i) { return __i; }
...
static __inline __m64 _mm_packs_pi64(__m64 __m1, __m64 __m2) {
...
/* Pack the two 32-bit values from M1 into the lower two 16-bit values of
   the result, and the two 32-bit values from M2 into the upper two 16-bit
   values of the result, all with unsigned saturation.  */
static __inline __m64 _mm_packs_pu32(__m64 __m1, __m64 __m2) {
...
static __inline __m64 _mm_packs_pu64(__m64 __m1, __m64 __m2) {
...
static __inline __m64 _mm_unpackel_pi8(__m64 __m1) {
...
static __inline __m64 _mm_unpackel_pi16(__m64 __m1) {
...
/* Take the 32-bit value from the high half of M1, and return it zero extended
  to 64 bits.  */
static __inline __m64 _mm_unpackeh_pu32(__m64 __m1) {
...
/* Add the 32-bit values in M1 to the 32-bit values in M2 using signed
   saturated arithmetic.  */
static __inline __m64 _mm_adds_pi32(__m64 __m1, __m64 __m2) {
...
/* Add the 32-bit values in M1 to the 32-bit values in M2 using unsigned
   saturated arithmetic.  */
static __inline __m64 _mm_adds_pu32(__m64 __m1, __m64 __m2) {
...
/* Subtract the 32-bit values in M2 from the 32-bit values in M1 using
   signed saturating arithmetic.  */
static __inline __m64 _mm_subs_pi32(__m64 __m1, __m64 __m2) {
...
/* Subtract the 32-bit values in M2 from the 32-bit values in M1 using
   unsigned saturating arithmetic.  */
static __inline __m64 _mm_subs_pu32(__m64 __m1, __m64 __m2) {
...
/* Multiply four 16-bit values in M1 by four 16-bit values in M2 producing
   four 32-bit intermediate results, which are then summed by pairs to
   produce two 32-bit results.  */
static __inline __m64 _mm_madd_pu16(__m64 __m1, __m64 __m2) {
...
/* Multiply four signed 16-bit values in M1 by four signed 16-bit values in
   M2 and produce the high 16 bits of the 32-bit results.  */
static __inline __m64 _mm_mulhi_pu16(__m64 __m1, __m64 __m2) {
...
static __inline __m64 _mm_sra_si64(__m64 __m, __m64 __count) {
  return (__m64)__builtin_arm_wsrad(__m, __count);
}

static __inline __m64 _mm_srai_si64(__m64 __m, int __count) {
...
static __inline __m64 _mm_ror_pi16(__m64 __m, __m64 __count) {
  return (__m64)__builtin_arm_wrorh((__v4hi)__m, __count);
}

static __inline __m64 _mm_rori_pi16(__m64 __m, int __count) {
  return (__m64)__builtin_arm_wrorhi((__v4hi)__m, __count);
}

/* Rotate two 32-bit values in M right by COUNT.  */
static __inline __m64 _mm_ror_pi32(__m64 __m, __m64 __count) {
  return (__m64)__builtin_arm_wrorw((__v2si)__m, __count);
}

static __inline __m64 _mm_rori_pi32(__m64 __m, int __count) {
  return (__m64)__builtin_arm_wrorwi((__v2si)__m, __count);
}

/* Rotate two 64-bit values in M right by COUNT.  */
static __inline __m64 _mm_ror_si64(__m64 __m, __m64 __count) {
  return (__m64)__builtin_arm_wrord(__m, __count);
}

static __inline __m64 _mm_rori_si64(__m64 __m, int __count) {
...
static __inline __m64 _mm_cmpgt_pu8(__m64 __m1, __m64 __m2) {
...
static __inline __m64 _mm_cmpgt_pu16(__m64 __m1, __m64 __m2) {
...
static __inline __m64 _mm_cmpgt_pu32(__m64 __m1, __m64 __m2) {
...
static __inline __m64 _mm_mac_pu16(__m64 __A, __m64 __B, __m64 __C) {
...
/* Element-wise multiplication of signed 16-bit values __B and __C, followed
   by accumulate across all elements and __A.  */
static __inline __m64 _mm_mac_pi16(__m64 __A, __m64 __B, __m64 __C) {
  return __builtin_arm_wmacs(__A, (__v4hi)__B, (__v4hi)__C);
}

/* Element-wise multiplication of unsigned 16-bit values __B and __C, followed
   by accumulate across all elements.  */
static __inline __m64 _mm_macz_pu16(__m64 __A, __m64 __B) {
  return __builtin_arm_wmacuz((__v4hi)__A, (__v4hi)__B);
}

/* Element-wise multiplication of signed 16-bit values __B and __C, followed
   by accumulate across all elements.  */
static __inline __m64 _mm_macz_pi16(__m64 __A, __m64 __B) {
  return __builtin_arm_wmacsz((__v4hi)__A, (__v4hi)__B);
}

/* Accumulate across all unsigned 8-bit values in __A.  */
static __inline __m64 _mm_acc_pu8(__m64 __A) {
  return __builtin_arm_waccb((__v8qi)__A);
}

/* Accumulate across all unsigned 16-bit values in __A.  */
static __inline __m64 _mm_acc_pu16(__m64 __A) {
  return __builtin_arm_wacch((__v4hi)__A);
}

/* Accumulate across all unsigned 32-bit values in __A.  */
static __inline __m64 _mm_acc_pu32(__m64 __A) {
  return __builtin_arm_waccw((__v2si)__A);
}

static __inline __m64 _mm_mia_si64(__m64 __A, int __B, int __C) {
  return __builtin_arm_tmia(__A, __B, __C);
}

static __inline __m64 _mm_miaph_si64(__m64 __A, int __B, int __C) {
  return __builtin_arm_tmiaph(__A, __B, __C);
}

static __inline __m64 _mm_miabb_si64(__m64 __A, int __B, int __C) {
  return __builtin_arm_tmiabb(__A, __B, __C);
}

static __inline __m64 _mm_miabt_si64(__m64 __A, int __B, int __C) {
  return __builtin_arm_tmiabt(__A, __B, __C);
}

static __inline __m64 _mm_miatb_si64(__m64 __A, int __B, int __C) {
  return __builtin_arm_tmiatb(__A, __B, __C);
}

static __inline __m64 _mm_miatt_si64(__m64 __A, int __B, int __C) {
...
static __inline __m64 _mm_sad_pu8(__m64 __A, __m64 __B) {
...
/* Compute the sum of the absolute differences of the unsigned 16-bit
   ...
   upper words are cleared.  */
static __inline __m64 _mm_sad_pu16(__m64 __A, __m64 __B) {
...
/* Compute the sum of the absolute differences of the unsigned 8-bit
   values in A and B.  Return the value in the lower 16-bit word; the
   upper words are cleared.  */
static __inline __m64 _mm_sadz_pu8(__m64 __A, __m64 __B) {
...
/* Compute the sum of the absolute differences of the unsigned 16-bit
   values in A and B.  Return the value in the lower 32-bit word; the
   upper words are cleared.  */
static __inline __m64 _mm_sadz_pu16(__m64 __A, __m64 __B) {
  return (__m64)__builtin_arm_wsadhz((__v4hi)__A, (__v4hi)__B);
}

static __inline __m64 _mm_align_si64(__m64 __A, __m64 __B, int __C) {
  return (__m64)__builtin_arm_walign((__v8qi)__A, (__v8qi)__B, __C);
}

/* Creates a 64-bit zero.  */
static __inline __m64 _mm_setzero_si64(void) { return __builtin_arm_wzero(); }

/* Set and Get arbitrary iWMMXt Control registers.
   Note only registers 0-3 and 8-11 are currently defined,
   the rest are reserved.  */

static __inline void _mm_setwcx(const int __value, const int __regno) {
  switch (__regno) {
  case 0:
    __builtin_arm_setwcx(__value, 0);
    break;
  case 1:
    __builtin_arm_setwcx(__value, 1);
    break;
  case 2:
    __builtin_arm_setwcx(__value, 2);
    break;
  case 3:
    __builtin_arm_setwcx(__value, 3);
    break;
  case 8:
    __builtin_arm_setwcx(__value, 8);
    break;
  case 9:
    __builtin_arm_setwcx(__value, 9);
    break;
  case 10:
    __builtin_arm_setwcx(__value, 10);
    break;
  case 11:
    __builtin_arm_setwcx(__value, 11);
    break;
  default:
    break;
  }
...
static __inline int _mm_getwcx(const int __regno) {
  switch (__regno) {
  case 0:
    return __builtin_arm_getwcx(0);
  case 1:
    return __builtin_arm_getwcx(1);
  case 2:
    return __builtin_arm_getwcx(2);
  case 3:
    return __builtin_arm_getwcx(3);
  case 8:
    return __builtin_arm_getwcx(8);
  case 9:
    return __builtin_arm_getwcx(9);
  case 10:
    return __builtin_arm_getwcx(10);
  case 11:
    return __builtin_arm_getwcx(11);
  default:
    return 0;
  }
}
...
static __inline __m64 _mm_set_pi16(short __w3, short __w2, short __w1,
                                   short __w0) {
...
static __inline __m64 _mm_setr_pi16(short __w0, short __w1, short __w2,
                                    short __w3) {
...
static __inline __m64 _mm_set1_pi32(int __i) { return _mm_set_pi32(__i, __i); }
...
static __inline __m64 _m_from_int(int __a) { return (__m64)__a; }
